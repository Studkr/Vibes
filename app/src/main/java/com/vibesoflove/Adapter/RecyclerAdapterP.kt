...
import com.vibesoflove.Personal
import com.vibesoflove.R

import de.hdodenhof.circleimageview.CircleImageView


class RecyclerAdapterP(private val horizontalGrocderyList: List<Room_constr>, var context: Context, var top: Personal) : RecyclerView.Adapter<RecyclerAdapterP.GroceryViewHolder>() {
    internal var pos = 0
